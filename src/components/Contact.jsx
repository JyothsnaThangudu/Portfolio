    ...
    <section id="contact" className="contact" ref={sectionRef}>
      ...
      <div className="contact-container">
        ...
        <p className={`section-subtitle ${isVisible ? 'animate-in' : ''}`}>
          Let's bring your ideas to life. I'm always excited to discuss new opportunities and creative projects.
        </p>
            ...
            <div className="info-card">
              ...
              <div className="contact-details">
                <div className="contact-item">
                  ...
                  <div className="contact-text">
                    <h4>Email</h4>
                    <a href="mailto:jyothsnathangudu@gmail.com">jyothsnathangudu@gmail.com</a>
                  </div>
                </div>
                ...
                <div className="contact-item">
                  ...
                  <div className="contact-text">
                    <h4>Phone</h4>
                    <a href="tel:+916305353700">+91 6305353700</a>
                  </div>
                </div>
              </div>
              ...
              <div className="social-section">
                ...
                <div className="social-links">
                  ...
                  <a href="https://www.linkedin.com/in/jyothsna-thangudu-972135257/
